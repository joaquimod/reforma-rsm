...
## 1. Escales interiors: jerarquia i funció

L'habitatge presenta tres situacions clarament diferenciades que requereixen solucions constructives i estètiques particulars.
...
### 1.2 Tram Planta Primera a Planta Segona (P1 -> P2)
Tram que connecta la zona de dia amb la zona de descans (dormitoris).
...
*   **Raonament:** En ser un espai més reduït, una escala oberta permet el pas de la llum i no carrega visualment el passadís de la P2. Se li dona un caràcter d'element singular, diferent de la resta de l'estructura de la casa.

---

## 2. Escala exterior (Terrassa P1 -> Pati PB)

Connexió directa entre la zona de dia i el pati posterior.
*   **Disseny:** Estructura de xapa d'acer plegada (disseny "acordió") volada sobre el mur lateral.
*   **Material:** Acer galvanitzat en calent (manteniment zero) o lacat en color gris fosc/negre.
*   **Seguretat:** Esglaons amb perforacions o relleu antilliscant. Substitució de la barana d'obra de la terrassa de la P1 per una barana lleugera de barrots verticals a joc amb l'escala.

---

## 3. Resum de materials per tram

| Tram | Tipus | Acabat Petja | Acabat Contrapetja |
| :--- | :--- | :--- | :--- |
| **PB -> P1** | Obra | Gres Porcellànic | Gres Porcellànic |
| **P1 -> P2** | Obra | SPC (Fusta tecnològica) | SPC (Fusta tecnològica) |
| **P2 -> PS** | Lleugera | Fusta Massissa | Oberta (Sense contrapetja) |
| **P1 -> Pati** | Exterior | Acer (Xapa plegada) | Oberta (Xapa plegada) |
