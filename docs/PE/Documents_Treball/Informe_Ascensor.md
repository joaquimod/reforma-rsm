...
## 1. Tipologies d'elevadors domèstics

En una rehabilitació d'habitatge unifamiliar, tenim bàsicament dues grans opcions tècniques:

### A. Ascensor Elèctric (MRL - Sense sala de màquines)
És l'ascensor "de tota la vida" però adaptat a ús unifamiliar.
*   **Velocitat:** Ràpida (0,15 m/s a 0,40 m/s).
*   **Tecnologia:** Motor *Gearless* (sense engranatges) situat dins del mateix forat.
*   **Pros:** Molt silenciós, poc consum elèctric, parada perfecta a nivell terra.
*   **Contres:** Requereix un "fossat" (pit) d'uns 20-30 cm i un espai de fugida al sostre superior d'uns 2,5 - 2,8 metres.

### B. Elevador Hidràulic
*   **Tecnologia:** Un pistó d'oli mou la cabina.
*   **Pros:** Molt robust, més econòmic d'instal·lació, requereix poc fossat (10-15 cm). Ideal si hi ha restriccions d'alçada a la teulada.
*   **Contres:** Més sorollós, més consum elèctric i pèrdua d'oli amb els anys (manteniment més "brut").

### C. Ascensor Pneumàtic (De buit)
*   **Tecnologia:** Un cilindre de vidre on la cabina puja per pressió d'aire.
*   **Pros:** Estètica 360º de visió. No requereix fossat.
*   **Contres:** Preu molt elevat, capacitat reduïda, més sorollós pel motor d'aspiració.

---

## 2. Marques i nivells de mercat

| Nivell | Marques de referència | Tipus de solució |
| :--- | :--- | :--- |
| **Nivell 1 (Luxe/Tech)** | **Otis (Gen2 Home)**, **Schindler**, **KONE** | Multinacionals. Màxima tecnologia, silenci absolut (cintes en lloc de cables). |
| **Nivell 2 (Estatals/Fiabilitat)** | **Orona**, **Eninter**, **Ascensores Sales** | Excel·lent relació qualitat-preu. Molt eficients i amb recanvis fàcils d'aconseguir. |
| **Nivell 3 (Dissenys especials)** | **Wolter**, **Nibav** | Especialistes en pneumàtics o elevadors de vidre "joia". |

---

## 3. Matriu de costos i manteniment (Estimacions 2026)

| Concepte | Elèctric (MRL) | Hidràulic | Pneumàtic |
| :--- | :---: | :---: | :---: |
| **Instal·lació (3 parades)** | 18.000 € - 25.000 € | 13.000 € - 17.000 € | 25.000 € - 38.000 € |
| **Consum elèctric anual** | 100 € - 150 € | 250 € - 400 € | 200 € - 250 € |
| **Manteniment anual** | 700 € - 900 € | 600 € - 800 € | 900 € - 1.200 € |

---

## 4. Estètica, estil i integració arquitectònica
...
3.  **Seguretat:** Sistemes de rescat automàtic integrats de sèrie en cas de tall elèctric.
