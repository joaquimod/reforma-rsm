...
Aquesta guia estableix els criteris per al Projecte Executiu de la Casa RSM, prioritzant la facilitat de neteja, la durabilitat dels materials i la comoditat diària dels usuaris (gent gran i mobilitat reduïda).
...
## 3. Cuina Forense
- **Taulell:** Porcellànic d'alta resistència (Dekton/Neolith) no porós.
- **Integració:** Pica sota-taulell per evitar el cantó de metall recull-brutícia.
- **Electrodomèstics:** Forn pirolític en columna i placa d'inducció amb extractor integrat (superfícies planes).
